	...
	<form action="{$link->getPageLink('address', true)|escape:'html':'UTF-8'}" method="post" class="std" id="add_address">
		...
		{foreach from=$ordered_adr_fields item=field_name}
			...
			{if $field_name eq 'vat_number'}
				<div id="vat_area" class="col-xs-12 col-md-6">
					<div id="vat_number">
			...
			{if $field_name eq 'postcode'}
				...
				<div class="required postcode form-group unvisible col-xs-12 col-md-6">
			...
			{if $field_name eq 'State:name'}
				...
				<div class="required id_state form-group col-xs-12 col-md-6">
			...
			{if $field_name eq 'phone'}
				...
				<div class="form-group phone-number col-xs-12 col-md-6">
			...
			{if $field_name eq 'phone_mobile'}
				...
				<div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group col-xs-12 col-md-6">
		...
		{/if}		
		{if !$stateExist}
			<div class="required id_state form-group unvisible col-xs-12 col-md-6">
				<label for="id_state">{l s='State'} <sup>*</sup></label>
				<select name="id_state" id="id_state" class="form-control">
					<option value="">-</option>
				</select>
		...
		{/if}
		{if !$dniExist}
			<div class="required dni form-group unvisible col-xs-12 col-md-6">
		...
		{/if}
		<div class="required form-group col-xs-12 col-md-6" id="adress_alias">
        ...
        <p class="submit2">
			...
			<button type="submit" name="submitAddress" id="submitAddress" class="btn btn-default button button-medium pull-right">
				<span>
					{l s='Save'}
