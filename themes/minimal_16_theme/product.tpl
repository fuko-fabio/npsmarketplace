                                        ...
                                        <li id="thumbnail_{$image.id_image}"{if $smarty.foreach.thumbnails.last} class="last"{/if}>
                                            <a
                                                ...
                                                <img class="img-responsive" id="thumb_{$image.id_image}"
                                                     ...
                                                     width="{$cartSize.width}" itemprop="image"/>
                                            </a>
                                        </li>
                                    {/foreach}
                                {/if}
            ...
            <div class="tabs-container col-xs-12">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade active in" id="product-more-info">
                        ...
                        <div class="row">
                            <div class="col-sm-9">
                                {l s='Quick money transfers with Przelewy 24.'}
                            </div>
                            <div class="col-sm-3">
                    ...
                    <div class="qty-inputs">
                        ...
                        {if ($display_qties == 1 && !$PS_CATALOG_MODE && $PS_STOCK_MANAGEMENT && $product->available_for_order)}
                            ...
                            <p id="pQuantityAvailable"{if $product->quantity <= 0} style="display: none;"{/if}>
                                <span id="quantityAvailableFrom">{l s='from'}</span>
...
*}
    ...
    {if $product->description_short || $packItems|@count > 0}
        <div id="short_description_block">
            <label class="short_description_label">{l s='Description'}</label>
                                        ...
                                        {if $field.type == 1}
                                            <li class="customizationUploadLine{if $field.required} required{/if}">
                                                ...
                                                <textarea name="textField{$field.id_customization_field}"
                                                          ...
                                                          id="textField{$customizationField}" rows="3" cols="20">{strip}
