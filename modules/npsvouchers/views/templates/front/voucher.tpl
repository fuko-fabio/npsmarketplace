...
{/capture}
{if isset($voucher.id)}
<h1 class="page-heading bottom-indent">{l s='Edit Voucher' mod='npsvouchers'}</h1>
{else}
<h1 class="page-heading bottom-indent">{l s='Add Voucher' mod='npsvouchers'}</h1>
{/if}
...
<div class="block-center" id="block-seller-voucher">
    <form role="form" action="{$request_uri}" method="post" id="edit-voucher-form">
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label class="required">{l s='Product' mod='npsvouchers'}</label>
                    <select class="is_required validate form-control" id="product_province" name="id_product" {if isset($voucher.id)}disabled=""{/if}>
        ...
        <div class="row">
            <div class="form-group col-md-6 input-append datetimepicker-from">
            ...
            <div class="form-group col-md-6 input-append datetimepicker-to">
        ...
        <div class="form-buttons">
            ...
            {/if}
            <button type="submit" class="btn btn-default button button-medium pull-right" name="saveVoucher">
                <span>
                {if isset($voucher.id)}
