<div>
  ...
  <table style="width: 100%; font-size: 8pt; ">
    <tr style="background-color: #4D4D4D; color: #FFF; line-height:6px;">
      ...
      <td style="text-align: left; font-weight: bold; width: 20%">{l s='Type' mod='npsticketdelivery'}</td>
      <td style="text-align: left; font-weight: bold; width: 10%">{l s='Price' mod='npsticketdelivery'}</td>
      <td style="text-align: left; font-weight: bold; width: 20%">{l s='Ticket nr' mod='npsticketdelivery'}</td>
      <td style="text-align: left; font-weight: bold; width: 20%">{l s='Date' mod='npsticketdelivery'}</td>
      <td style="text-align: left; font-weight: bold; width: 10%">{l s='Notes' mod='npsticketdelivery'}</td>
    </tr>
