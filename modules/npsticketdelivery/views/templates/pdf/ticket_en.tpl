            ...
            <tr>
                ...
                <td style="font-size: 14px;border-top: 1px dashed black;border-bottom: 1px dashed black;width: 500px">
                    <div style="margin-left: 10px">
                        ...
                        <div style="width:100px;text-transform: uppercase;float: left;display: inline-block;">{l s='Term' mod='npsticketdelivery'}</div>: <span style="font-weight: 700;float: left">{date_format(date_create($date), 'Y-m-d H:i')}</span><br />
                        {else if $type == 1 && isset($entries) && $entries > 0}
                        <div style="width:100px;text-transform: uppercase;float: left;display: inline-block;">{l s='Entries' mod='npsticketdelivery'}</div>: <span style="font-weight: 700;float: left">{$entries}</span><br />
                        {else if $type == 1 && strtotime($from) > 0 && strtotime($to) > 0}
                        <div style="width:100px;text-transform: uppercase;float: left;display: inline-block;">{l s='Valid' mod='npsticketdelivery'}</div>: <span style="font-weight: 700;float: left">{date_format(date_create($from), 'Y-m-d')} - {date_format(date_create($to), 'Y-m-d')}</span><br />
                        {/if}
                        <br />
                        <div style="width:100px;text-transform: uppercase;float: left;display: inline-block;">{l s='Person' mod='npsticketdelivery'}</div>: <span style="float: left;text-overflow: ellipsis;white-space: nowrap;">{$person|truncate:60}</span><br />
                        <div style="width:100px;text-transform: uppercase;float: left;display: inline-block;">{l s='Address' mod='npsticketdelivery'}</div>: <span style="float: left;text-overflow: ellipsis;white-space: nowrap;">{$address|truncate:60}</span><br />
                        <div style="width:100px;text-transform: uppercase;float: left;display: inline-block;">{l s='District' mod='npsticketdelivery'}</div>: <span style="float: left;text-overflow: ellipsis;white-space: nowrap;">{$district|truncate:60}</span><br />
                        <div style="width:100px;text-transform: uppercase;float: left;display: inline-block;">{l s='Town' mod='npsticketdelivery'}</div>: <span style="float: left;text-overflow: ellipsis;white-space: nowrap;">{$town|truncate:60}</span><br />
                    </div>
                    <br />
                    {if $gift}
