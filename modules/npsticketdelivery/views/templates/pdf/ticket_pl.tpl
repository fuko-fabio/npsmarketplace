            ...
            <tr>
                ...
                <td style="font-size: 14px;border-top: 1px dashed black;border-bottom: 1px dashed black;width: 500px">
                    <div style="margin-left: 10px">
                        ...
                        <div style="font-size: 10px;width:100px;text-transform: uppercase;float: left;display: inline-block;">Ilość wejść</div>: <span style="font-weight: 700;float: left">{$entries}</span><br />
                        ...
                        <div style="font-size: 10px;width:100px;text-transform: uppercase;float: left;display: inline-block;">Miasto</div>: <span style="float: left;text-overflow: ellipsis;white-space: nowrap;">{$town|truncate:60}</span><br />
                        {if isset($seller_name)}
                        <div style="font-size: 10px;width:100px;text-transform: uppercase;float: left;display: inline-block;">Sprzedawca</div>: <span style="float: left;text-overflow: ellipsis;white-space: nowrap;">{$seller_name|truncate:60}</span><br />
                        {/if}
                    </div>
                    <br />
                    {if $gift}
