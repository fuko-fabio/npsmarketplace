...
class NpsFavoriteProduct extends ObjectModel
{
	public $id;
	...
	public static function getNpsFavoriteProducts($id_customer, $id_lang)
	{
	...
	public static function getNpsFavoriteProduct($id_customer, $id_product, Shop $shop = null)
	{
		if (!$shop)
		...
		if ($id_favorite_product)
			return new NpsFavoriteProduct($id_favorite_product);
		return null;
	}

	public static function isCustomerNpsFavoriteProduct($id_customer, $id_product, Shop $shop = null)
	{
		if (!$id_customer)
			return false;
