                ...
                <form id="id_new_seller_comment_form" class="row" action="#">
                    <div class="clearfix col-xs-12 col-sm-6 seller">
                        {if isset($npscomments_cover_image) && !empty($npscomments_cover_image)}
                            <img src="{$npscomments_cover_image}" height="{$npscomments_mediumSize.height}" width="{$npscomments_mediumSize.width}" alt="{$seller->name[{$current_id_lang}]|escape:html:'UTF-8'}"/>
                        {else}
                        ...
                        {$seller->description[{$current_id_lang}]}
                    </div>
                    <div class="clearfix col-xs-12 col-sm-6 seller">
