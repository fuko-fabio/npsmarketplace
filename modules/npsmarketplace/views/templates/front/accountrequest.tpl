    ...
    <form action="{$request_uri|escape:'html':'UTF-8'}" method="post" class="std" id="formaccountrequest">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <textarea class="validate form-control" data-validate="isMessage" id="company_description" name="company_description" rows="6">{if isset($smarty.post.company_description)}{$smarty.post.company_description|escape:'html':'UTF-8'|stripslashes}{/if}</textarea>
            </div>
            <div class="form-group">
