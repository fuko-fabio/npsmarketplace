...
class P24DispatchHistory extends ObjectModel {
    ...
    public static $definition = array(
        ...
        'fields' => array(
            ...
            'sellers_amount' =>  array('type' => self::TYPE_STRING, 'validate' => 'isUnsignedInt'),
            'sellers_number' =>  array('type' => self::TYPE_STRING, 'validate' => 'isUnsignedInt'),
            'merchant_amount' => array('type' => self::TYPE_STRING, 'validate' => 'isUnsignedInt'),
            'p24_amount' =>      array('type' => self::TYPE_STRING, 'validate' => 'isUnsignedInt'),
            'total_amount' =>    array('type' => self::TYPE_STRING, 'validate' => 'isUnsignedInt'),
