...
<div class="block-center" id="block-seller-payment-settings">
    ...
    <form role="form" action="{$request_uri}" method="post">
        ...
        <button type="submit" name="submitCompany" class="btn btn-primary btn-lg pull-right"><span>{l s='Register' mod='npsprzelewy24'} <i class="icon-save right"></i></span></button>
    </form>
</div>