				...
				<div class="comment_details">
					...
					<ul>
						{if $comment.total_advice > 0}
							<li>{l s='%1$d out of %2$d people found this review useful.' sprintf=[$comment.total_useful,$comment.total_advice] mod='npsmsellercomments'}</li>
						{/if}
		...
		<form id="id_new_seller_comment_form" action="#">
			...
			<div class="new_seller_comment_form_content">
				...
				<div id="new_seller_comment_form_footer">
					...
					<p class="fl required"><sup>*</sup> {l s='Required fields' mod='npsmsellercomments'}</p>
					<p class="fr">
						<button id="submitSellerNewMessage" name="submitSellerMessage" type="submit">{l s='Send' mod='npsmsellercomments'}</button>&nbsp;
